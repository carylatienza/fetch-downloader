...
const PLATFORM_DATA = [
  {
    ...
    cardClass: styles.ytCard,
    spotlightColor: 'rgba(255, 60, 60, 0.16)',
  ...
  },
  {
    ...
    cardClass: styles.igCard,
    spotlightColor: 'rgba(228, 64, 95, 0.16)',
  ...
  },
  {
    ...
    cardClass: styles.fbCard,
    spotlightColor: 'rgba(24, 119, 242, 0.16)',
  ...
  return (
    <section className={styles.section}>
      ...
      <div className={styles.grid}>
        {PLATFORM_DATA.map(({ id, name, LogoComponent, cardClass, spotlightColor, description, features }) => (
          <SpotlightCard
            key={id}
